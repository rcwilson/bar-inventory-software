...
function Login(props) {
    ...
    const [inputUsername, setInputUsername] = useState("admin@admin");
    ...
    function handleLogin(e) {
        ...
        if ( form.checkValidity() ) {
            API.Users.login({ username: inputUsername, password: inputPassword })
            .then( res => {
                //console.log(res)
                if(res?.success) { 
            ...
            <Row lg={8} className="justify-content-md-center p-4">
                <Form id="login-form" noValidate validated={ formValidated } >
                    <Form.Group as={Col} className="mb-3" controlId="formUserName">
                        ...
                        <Form.Control defaultValue={ inputUsername} onChange={e => setInputUsername(e.target.value) } required autoComplete="off" type="email" placeholder="user@unioncafe.com" />
                    ...
                    <Form.Group as={Col} className="mb-3" controlId="formUserPassword">
                        ...
                        <Form.Control defaultValue={inputPassword} onChange={ e => setInputPassword(e.target.value) } required type="password" placeholder="Password" />
                        <Form.Control.Feedback type="invalid">
                            Password Required
                        </Form.Control.Feedback>
                    </Form.Group>
